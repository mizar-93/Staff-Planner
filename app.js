...
async function renderProduction() {
  ...
  const record = stored || {
    ...
    machines: Object.fromEntries(machines.map(machine => [machine, {
      personId: scheduleDay ? schedule[machine]?.[scheduleDay] || "" : "", result: "", waste: "", comment: ""
    }]))
  };
