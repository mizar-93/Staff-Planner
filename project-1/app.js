...
async function renderProduction() {
  ...
  root.innerHTML = `
    ...
    <div class="production-kpis"><article id="productionTotalCard" class="${total >= target ? "goal-card-met" : "goal-card-missed"}"><span>Dagens produktion</span><strong id="productionTotal">${total}</strong><small>box totalt</small></article><article><span>Dagligt mål</span><strong id="productionGoalValue">${target}</strong><small>box</small></article><article><span>Fabriksrekord</span><strong>${settings.factoryRecord}</strong><small>officiellt rekord</small></article><article><span>Högsta registrerade</span><strong>${highestRecorded}</strong><small>i historiken</small></article></div>
